...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets') }}/img/logos/act_now-favicon.png">
    <link rel="icon" type="image/png" href="{{ asset('assets') }}/img/logos/act_now-favicon.png">
