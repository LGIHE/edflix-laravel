                        ...
                        <!-- Email Header -->
                            <tr>
                                <td class="content-cell" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; padding: 35px;">
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; color: #718096; font-size: 16px; line-height: 1.5em; margin-top: 0;">Someone has commented on the <strong>{{ $user->comment->target_field }}</strong> on your lesson plan</p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; color: #718096; font-size: 16px; line-height: 1.5em; margin-top: 0;">Below are the lesson plan details:</p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; color: #718096; font-size: 16px; line-height: 1.5em; margin-top: 0;">Topic:&nbsp; {{ $user->lesson_plan->topic }}</p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; color: #718096; font-size: 16px; line-height: 1.5em; margin-top: 0;">Theme:&nbsp; {{ $user->lesson_plan->theme}}</p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; color: #718096; font-size: 16px; line-height: 1.5em; margin-top: 0;">Class:&nbsp; {{ $user->lesson_plan->class}}</p>
                                    <!-- Action Button -->
